...
**Recommended:** A stood for thirteen business days on the plan's text. The evidence changed on 2026-07-09: the founder spent the day shipping pricing v2 on the boreas-website repo (8 commits: founder lifetime rate at $199/seat/mo for the first 100 Pro seats, Practice seat-band pricing at $2,500/$3,600/$4,500 per band, live self-serve Stripe checkout, license-server hardening, api repoint). That is a founder acting like Option B, not Option A. The plan says demo-only; the founder's hands say self-serve product. The recommendation is no longer A by default; it is: rule this explicitly, today if possible. If the Jul 9 work means the product track is live on purpose, say B and the queue gets re-baselined around a real second go-to-market (which also makes D-0009 Option B live again). If Jul 9 was momentum, not strategy, say A and the retire executes as written.
**New evidence 2026-07-09:** boreas-website commits d74b111 through f7ac8ef (pricing v2, live checkout, seat-band Practice licensing). Also resolves T-0010's open question in practice: Practice tier shipped as seat bands, not named-role seats. One word from the founder confirms it and T-0010 closes.
**Status:** open (14 business days; surfaced 2026-06-22, carried daily on business days since, with no ruling; evidence amended 2026-07-10 after the founder's Jul 9 pricing-v2 push)
